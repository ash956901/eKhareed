...
const CartItem = ({ item, itemIndex }) => {
  ...
  return (
    <div className="py-4 px-10 border-b-4">
      <div className="flex flex-row gap-10">
        <div>
          <img alt={item.image} className="w-[170px] h-auto" src={item.image} />
        </div>
        ...
        <div className="w-[350px]">
          ...
          <div className="flex mt-5 flex-row justify-between items-center">
            ...
            <div
              className="bg-red-500 w-6 px-4 py-2 rounded-full relative flex-col flex items-center justify-center cursor-pointer 
          hover:bg-red-300 transition-all duration-300 ease-in"
